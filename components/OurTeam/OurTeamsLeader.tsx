            ...
            <div className="container">
                <div className="max-w-lg mx-auto mb-12 text-center">
                    ...
                    <h2 className="text-3xl md:text-4xl mt-2 mb-4 font-bold font-heading wow animate__animated animate__fadeIn animated" data-wow-delay=".1s">
                        Conoce a tus  <span className="text-blue-500">Expertos</span> <br />
                        Miembro del equipo
                    </h2>
                    <p className="text-blueGray-400 leading-loose wow animate__animated animate__fadeIn animated" data-wow-delay=".1s">Nuestros clientes muy contentos con nuestros servicios.</p>
                </div>
